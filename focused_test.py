...
def test_forex_live_data():
    ...
    try:
        response = requests.get("https://realtime-signals-9.preview.emergentagent.com/api/market/forex", timeout=30)
...
def test_indian_market_data():
    ...
    try:
        response = requests.get("https://realtime-signals-9.preview.emergentagent.com/api/market/indian", timeout=30)
...
def test_signal_diversity():
    ...
    try:
        login_response = requests.post(
            "https://realtime-signals-9.preview.emergentagent.com/api/auth/login",
        ...
        for asset in test_assets:
            try:
                signal_response = requests.post(
                    "https://realtime-signals-9.preview.emergentagent.com/api/signals/generate",
                    json={
